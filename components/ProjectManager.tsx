...
const ProjectManager: React.FC<ProjectManagerProps> = ({ projects, selectedProjectIds, userRole, onAdd, onUpdate, onDelete, onDiscover, onSelect, onClose }) => {
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {isAdmin && (
                        <div className="flex gap-1">
                          <button onClick={() => onDiscover(project.id)} className="p-2 text-slate-500 hover:text-blue-400" title="Sync Sheets">🔄</button>
