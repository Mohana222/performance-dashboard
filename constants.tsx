...
export const API_URL = "https://script.google.com/macros/s/AKfycbxS4B8sosypPeNzY9ygHvXciG-iE8TMuV7r7xTBhX5O08vkmIRKaPFmpU5g7pFjhwiM0g/exec";
...
export const PRIVACY_POLICY = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: "Data is stored securely in our backend database and fetched directly from authorized Google Sheets."
    }
  ]
};
...
export const ABOUT_INFO = {
  ...
  purpose: "The User Performance Dashboard provides real-time visibility into complex annotation projects directly from Google Sheets with secure backend persistence.",
